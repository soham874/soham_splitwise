...
export default function TripDetailPage({
  ...
  return (
    <div className="container mx-auto py-8 px-4 max-w-3xl">
      ...
      <button
        onClick={onEditTrip}
        className="w-full bg-gray-50 border border-gray-200 rounded-xl p-4 text-center text-sm font-semibold text-gray-600 hover:bg-gray-100 hover:border-gray-300 transition"
      >
        Edit Trip Details
      </button>
    </div>
